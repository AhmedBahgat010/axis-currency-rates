...
class ExchangeRatesListScreen extends StatefulWidget {
  ...
  @override
  State<ExchangeRatesListScreen> createState() => _ExchangeRatesListScreenState();
}
        ...
        builder: (context, state) {
          if (state is RatesListLoading) {
            ...
            return ErrorRetryView(
              ...
              onRetry: () => context.read<RatesListBloc>().add(const FetchRatesEvent()),
            );
          } else if (state is RatesListLoaded || state is RatesListLoadedFromCache) {
            ...
            return Column(
              children: [
                if (isOffline) OfflineBanner(lastUpdated: lastUpdated),
                Padding(
